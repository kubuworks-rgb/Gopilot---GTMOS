...
export interface Brief { account: Account; why_it_fits: EvidenceClaim[]; why_now: EvidenceClaim[]; pain_hypotheses: EvidenceClaim[]; recommended_problem: string; recommended_offer: string; recommended_action: string; risks: string[]; evidence: Evidence[]; sources: Source[]; signals: Signal[]; verified_facts: EvidenceClaim[]; unknowns: string[]; research_candidate: boolean; campaign: Campaign; generated_at: string }
